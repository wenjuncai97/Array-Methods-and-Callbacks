...
const fifa2014 = fifaData.filter(item => item.Year === 2014 && item.Stage === 'Final');
...
function getFinals(array) {
   const newArray = array.filter(data => data.Stage === 'Final') //the 'data' is just a placement word. could be item, banana, etc. same goes for array. those are just placement words that will be invoked as arguments.
   return newArray;
}
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 3: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀
...
//we want to reduce our data to only the team initials, then whatever team initial we put into the parameter, it should return with how many wins its had.
